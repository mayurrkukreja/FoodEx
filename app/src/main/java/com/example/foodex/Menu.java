...
public class Menu extends AppCompatActivity implements ItemListAdapter.ItemClicked {
    ...
    public void onItemClicked(int index) {
        ...
        if(ApplicationClass.item.get(index).getMake().equals("samosa"))
        {
            ivMake.setImageResource(R.drawable.samosa);
        }
        else if(ApplicationClass.item.get(index).getMake().equals("rice"))
        {
            ivMake.setImageResource(R.drawable.rice);
        }
        else if(ApplicationClass.item.get(index).getMake().equals("paneer"))
        {
            ivMake.setImageResource(R.drawable.paneer);
        }
        else if(ApplicationClass.item.get(index).getMake().equals("noodles"))
        {
            ivMake.setImageResource(R.drawable.noodles);
        }
        else if(ApplicationClass.item.get(index).getMake().equals("pavbhaji"))
        {
            ivMake.setImageResource(R.drawable.pavbhaji);
        }
        else
        {
            ivMake.setImageResource(R.drawable.cholebhature);
        }
